...
FillDD classic
Query per gli archi con in ingresso anno, paese e idMap che restituisce gia la lista corretta di archi
Per la somma dei pesi degli archi di un nodo guarda metodo: def computeVolume(self)
